...
public final class KKC {
  ...
  public final class S {
    ...
    public static final int SYSTEMUI_UI_MODE_ANDROID = 1;
    public static final int SYSTEMUI_UI_MODE_NAVBAR_LEFT = 2;
    public static final int SYSTEMUI_UI_MODE_NAVBAR_BALANCED = 0;
  ...
  public final class A {
	    ...
	    public static final String SPLITVIEW_SWAP = "splitview_swap";
	    ...
	    public static final String AUTOROTATION_TOGGLE = "autorotation";
            ...
            public static final String INPUT_LANGUAGE_SWITCH = "input_language_switch";
