...
public class GestureRecorder {
    ...
    /**
     * Generates a JSON string capturing all completed gestures. Not threadsafe;
     * call with a lock.
     */
    ...
    public void save() {
        synchronized (mGestures) {
            try {
                BufferedWriter w = new BufferedWriter(new FileWriter(mLogfile, /*
                                                                                * append
                                                                                * =
                                                                                */true));
