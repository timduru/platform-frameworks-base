...
public class EosNxHandler {

    private static NX nx = null;

    public static void create(Context context, NavigationBarView view, PhoneStatusBar bar) {
        nx = new NX(context, view, bar);
    }

    public static boolean isNxEnabled() {
        if (nx == null) {
            return false;
        } else {
            return nx.mNX;
    ...
    public static boolean isSearchLightOn() {
        if (nx == null) {
            return false;
        } else {
            return nx.mSearchLightOn;
        }
    }

    public static boolean isSearchLightLongPress() {
        if (nx == null) {
            return false;
        } else {
            return nx.mSearchLightLongPress;
        }
    }

    public static void setSearchLightOn(boolean state) {
        if (nx == null)
            return;
        nx.mSearchLightOn = state;
    }

    public static void setSearchLightLongPress(boolean state) {
        if (nx == null)
            return;
        nx.mSearchLightLongPress = state;
    }

    private static class NX implements OnFeatureStateChangedListener {
        ...
        public NX(Context context, NavigationBarView view, PhoneStatusBar bar) {
            mContext = context;
        ...
        private void registerUriList() {
            MSG_NX_BAR_SETTINGS = EosObserverHandler.getEosObserverHandler()
                    .registerUri(EOSConstants.SYSTEMUI_USE_NX_NAVBAR);

            EosObserverHandler.getEosObserverHandler()
                    .setOnFeatureStateChangedListener((OnFeatureStateChangedListener) NX.this);
        }
