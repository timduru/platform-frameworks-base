...
public class AdbController extends SettingsController
{
    ...
    protected boolean adbStart()
    {
        ...
        else
        {
            Toast toast = Toast.makeText(mContext,
                    (CharSequence) "Turn Wifi on before enabling Wireless ADB", Toast.LENGTH_LONG);
            toast.show();
            mPreferenceState = 0;
        }
        return true;
    ...
    protected boolean adbStop()
    {
        ...
        SystemProperties.set("persist.service.adb.enable", "0");
        SystemProperties.set("persist.service.adb.enable", "1");
        Toast toast = Toast.makeText(mContext, (CharSequence) "Disabling Adb Wireless Service",
                Toast.LENGTH_LONG);
        toast.show();
        mPreferenceState = 0;
        return true;
