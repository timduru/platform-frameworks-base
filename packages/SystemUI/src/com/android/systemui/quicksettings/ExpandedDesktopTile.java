...
public class ExpandedDesktopTile extends QuickSettingsTile {
    ...
    public ExpandedDesktopTile(Context context,
        ...
        mOnClick = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Settings.System.putInt(mContext.getContentResolver(), Settings.System.EXPANDED_DESKTOP_STATE, mEnabled ? 0 : 1);
            }
        };
    ...
    private synchronized void updateTile() {
        mEnabled = Settings.System.getInt(mContext.getContentResolver(), Settings.System.EXPANDED_DESKTOP_STATE, 0 ) == 1;
        if (mEnabled) {
